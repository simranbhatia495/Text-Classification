...
"""****************changed function definition from best_first_graph_search(problem,h)*************"""
def best_first_graph_search1(problem):
    ...
    """**************************changed from f=memoize(f,'f')************************8"""
    f = memoize(problem.h, 'f')
...
"""****************changed function definition from astar_search(problem, h=None)**************"""
